...
- **[OpsMind](https://github.com/Pawansingh3889/OpsMind)** — on-prem AI over
  manufacturing data: natural-language-to-SQL through a LangGraph agent, RAG
  over pgvector / ChromaDB, models served locally by Ollama, with an eval
  harness.
